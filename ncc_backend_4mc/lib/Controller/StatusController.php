	...
	public function status(): DataResponse {
		...
		return new DataResponse([
			'status' => [
				...
				'license_status' => $licenseSnapshot['license_status_effective'] ?? 'UNKNOWN',
				'access_status' => $licenseSnapshot['status_effective'] ?? 'UNKNOWN',
				'can_manage_license' => $isAdmin,
				'license_activation' => $licenseSnapshot['activation'] ?? null,
				'license_last_sync_at_iso' => $licenseSnapshot['last_sync_at_iso'] ?? null,
				'license_connection_error' => !empty($licenseSnapshot['last_error']),
				'license_offline_until_iso' => $licenseSnapshot['offline_until_iso'] ?? null,
