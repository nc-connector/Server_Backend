				...
				<tr>
					<td style="padding:0;">
						<table role="presentation" width="640" height="32" style="border-collapse:collapse;width:640px;height:32px;margin:0;background-color:transparent;">
							<tbody>
								<tr>
									<td style="padding:0;background-color:#0082C9;text-align:center;height:32px;min-height:32px;max-height:32px;line-height:32px;vertical-align:middle;">
										<a href="https://nc-connector.de" style="display:inline-block;text-decoration:none;vertical-align:middle;line-height:0;" target="_blank" rel="noopener">
											<img style="display:block;width:auto;height:auto;max-height:32px;max-width:164px;object-fit:contain;border:0;margin:0 auto;vertical-align:middle;" src="https://raw.githubusercontent.com/nc-connector/.github/refs/heads/main/profile/header-solid-blue.png">
										</a>
									</td>
								</tr>
							</tbody>
...
<p>Nextcloud Talk</p>
<p>Join the meeting now:<br>{MEETING_URL}</p>
<p>Password: {PASSWORD}</p>
<p>Need help?</p>
<p>https://docs.nextcloud.com/server/latest/user_manual/en/talk/join_a_call_or_chat_as_guest.html</p>
HTML;
	...
	private function normalizeTemplateBranding(string $template): string {
		...
		$template = str_replace(
			[
				'src="../../apps/nc_connector/img/header.png"',
				"src='../../apps/nc_connector/img/header.png'",
				'src="../img/header.png"',
				"src='../img/header.png'",
			],
		...
		$template = str_replace(
			'padding:0;background-color:#0082C9;text-align:center;height:32px;min-height:32px;max-height:32px;line-height:32px;',
			'padding:0;background-color:#0082C9;text-align:center;height:32px;min-height:32px;max-height:32px;line-height:32px;vertical-align:middle;',
			$template
		);

		$template = str_replace(
			'display:inline-block;text-decoration:none;"',
			'display:inline-block;text-decoration:none;vertical-align:middle;line-height:0;"',
			$template
		);
		...
		$template = str_replace(
			'display:block;width:auto;height:32px;max-height:32px;max-width:164px;object-fit:contain;border:0;margin:0 auto;',
			'display:block;width:auto;height:auto;max-height:32px;max-width:164px;object-fit:contain;border:0;margin:0 auto;vertical-align:middle;',
			$template
		);
	...
	private function isAddonControllableSetting(string $key): bool {
		return !$this->isTemplateEditorSetting($key);
	}
	...
	private function cacheTemplateImage(string $contextKey, int $index, string $source): ?string {
		try {
			...
			$this->logError('Template image cache failed: ' . $exception->getMessage(), [
				'app' => Application::APP_ID,
				'context_key' => $contextKey,
				'src' => $source,
				'exception' => $exception,
